...
//Monitor the execution context by name

class ByNameThreadMonitorActor(executionContextName: String) extends Actor {

  implicit val actorSystem: ActorSystem = context.system
  implicit val ec: ExecutionContext = context.system.dispatchers.lookup(executionContextName)
